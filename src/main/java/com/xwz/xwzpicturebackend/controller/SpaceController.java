...
import com.xwz.xwzpicturebackend.domain.dto.space.SpaceEditRequest;
import com.xwz.xwzpicturebackend.domain.dto.space.SpaceLevel;
import com.xwz.xwzpicturebackend.domain.dto.space.SpaceQueryRequest;
import com.xwz.xwzpicturebackend.domain.dto.space.SpaceUpdateRequest;
...
public class SpaceController {
    ...
    /**
     * 空间删除接口，因为逻辑比较简单就直接在这里处理  仅本人或者管理员可删除
     * @param deleteRequest
     * @param request
     * @return
     */
