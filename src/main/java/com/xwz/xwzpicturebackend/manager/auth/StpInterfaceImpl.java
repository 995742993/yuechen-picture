...
/**
 * 自定义权限加载接口实现类，全局鉴权（公共，私有，团队，图片，空间）
 */
...
public class StpInterfaceImpl implements StpInterface {
    ...
    /**
     * 返回一个账号所拥有的权限码集合
     * 多层级权限校验：核心思想是 根据上下文动态适配权限规则，适合复杂的空间权限管理场景。
     */
    @Override
    ...
    private SpaceUserAuthContext getAuthContextByRequest() {
        // 如下是 Spring MVC 中获取当前 HTTP 请求对象（HttpServletRequest） 的一种方式，通常用于在非 Controller 层（如 Service、工具类等）获取当前请求的信息。
        ...
        // 根据请求路径区分 id 字段的含义，如果说不为空的话，那么就意味着原始入参就包含着某个具体业务ID，或者说全无，那就是管理员权限了
