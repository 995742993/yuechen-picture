package com.xwz.xwzpicturebackend.manager.auth.annotation;
 ...
 * @author  xwz
 */
@SaCheckPermission(type = StpKit.SPACE_TYPE) // 注解合并，相当于当前自定义的 @SaSpaceCheckPermission == @SaCheckPermission(type = StpKit.SPACE_TYPE)
