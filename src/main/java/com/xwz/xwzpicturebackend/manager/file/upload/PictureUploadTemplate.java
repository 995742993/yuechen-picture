...
import com.xwz.xwzpicturebackend.config.CosClientConfig;
...
/**
 * @author 度星希
 * @createTime 2025/3/29 20:41
 * @description 上传图片模板抽象父类
 */
@Service
@Slf4j
public abstract class PictureUploadTemplate {
     ...
     * 上传图片
     *
     * @param inputSource    输入源，也可能是文件，也有可能是URL
    ...
    private UploadPictureResult buildResult(ImageInfo imageInfo, String originFilename, File file, String uploadPath) {
        ...
        // imageInfo就是数据万象服务解析好的数据实体，里面包含着主色调信息
